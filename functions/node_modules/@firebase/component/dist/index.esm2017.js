...
class Provider {
    ...
    getImmediate(options) {
        var _a, _b;
        const identifier = (_a = options === null || options === void 0 ? void 0 : options.identifier) !== null && _a !== void 0 ? _a : DEFAULT_ENTRY_NAME;
        const optional = (_b = options === null || options === void 0 ? void 0 : options.optional) !== null && _b !== void 0 ? _b : false;
        // if multipleInstances is not supported, use the default name
        const normalizedIdentifier = this.normalizeInstanceIdentifier(identifier);
        if (this.isInitialized(normalizedIdentifier) ||
            this.shouldAutoInitialize()) {
